(function() {
  // create controller
  var Report1Controller = function($scope, dataService) {
  ...
  app.controller('Report1Controller', ['$scope', 'dataService', Report1Controller]);
  //app.controller('Report1Controller', ['$scope', Report1Controller]);
}());
