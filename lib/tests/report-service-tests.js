...
(function(){
	...
	requirejs(['../services/logService.js', '../services/report3Service.js'], function() {
		mocha.setup('bdd');

		var logService = window.services.logService()
			, service = window.services.report3Service(logService);
		logService.safeLog('loaded', service);
